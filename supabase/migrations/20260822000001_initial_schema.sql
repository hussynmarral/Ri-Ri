...
-- ─── routine_templates ───────────────────────────────────────
-- The recurring blueprint for daily blocks
create table public.routine_templates (
  ...
  days_of_week      smallint[] not null default array[1,2,3,4,5,6,7], -- 1=Mon
...
-- ─── schedule_overrides ──────────────────────────────────────
-- Temporary single-day changes to a routine block
...
-- ─── schedule_instances ──────────────────────────────────────
-- Daily expanded instances (generated from templates or created ad-hoc)
...
create table public.habit_logs (
  id            uuid primary key default uuid_generate_v4(),
  user_id       uuid not null references public.profiles(id) on delete cascade,
  habit_key     text not null, -- 'reading','english','turkish','skincare','haircare','supplements'
  log_date      date not null,
  completed     boolean not null default false,
  value_numeric numeric,       -- pages read, minutes, etc.
  created_at    timestamptz not null default now(),
  updated_at    timestamptz not null default now(),
